...
insert into offices (id, room, meta, price_day_nok, price_week_nok, price_month_nok)
values
('a', 'Kontor A', 'Hjørnekontor · 1–2 personer · 12 m²', 490, 2500, 6500),
('b', 'Kontor B', 'Midtkontor · 1–2 personer · 12 m²', 490, 2500, 6500),
('c', 'Kontor C', 'Lite kontor · 1 person', 390, 1900, 4900)
on conflict (id) do update set
  room = excluded.room,
  meta = excluded.meta,
  price_day_nok = excluded.price_day_nok,
  price_week_nok = excluded.price_week_nok,
